...
int main(int argc, char *argv[])
{
    ...
    glm::mat4 fullTransformationMatrices[] = {
        glm::translate(projectionMatrix, glm::vec3(-1.0f, 0.0f, -3.0f)) *
    ...
    //copy our transformation matrix instanced data to buffer
    glBindBuffer(GL_ARRAY_BUFFER, TBO);
    glBufferData(GL_ARRAY_BUFFER, sizeof(fullTransformationMatrices), fullTransformationMatrices, GL_STATIC_DRAW);
